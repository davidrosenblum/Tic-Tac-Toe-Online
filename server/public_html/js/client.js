...
(function(){
    // constants
    var VERSION = "1.0.0",
        IMAGE_X = document.createElement("img"),
        IMAGE_O = document.createElement("img"),
        BOX_SIZE = 50;

    IMAGE_X.setAttribute("src", "img/mark_x.png");
    IMAGE_O.setAttribute("src", "img/mark_o.png");
    ...
    var initGameOffline = function(chosenMark){
        ...
        displayGameMessage("You are " + mark.toUpperCase() + " and CPU is " + cpuMark.toUpperCase() + ".");
    };
    ...
    var render = function(){
        ...
        for(var y = 0; y < gameMatrix.length; y++){
            for(var x = 0; x < gameMatrix[y].length; x++){
                ...
                if(box.mark){
                    if(box.mark === "o"){
                        ctx.drawImage(IMAGE_O, box.x, box.y, box.width, box.height);
                    }
                    else if(box.mark === "x"){
                        ctx.drawImage(IMAGE_X, box.x, box.y, box.width, box.height);
                    }
                }
    ...
    var showPin = function(pinFromServer){
        if(typeof pinFromServer !== "string"){
            pinFromServer = (pin) ? pin : "No pin error.";
        }
    ...
    var init = function(){
        ...
        // cache misc elements
        gameButtons = document.querySelector("#game-btns-container");
        ...
        document.querySelector("#menu-btn").onclick = showPin;
        ...
        document.querySelector("#reset-game-btn").onclick = function(){
